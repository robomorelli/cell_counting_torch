...
class ResUnet(nn.Module):
    def __init__(self, n_features_start=16, n_out=1, ae_bin=False, c0=True):
...
def _resunet(
    ...
    model = ResUnet(n_features_start, n_out, ae_bin, c0)  # , **kwargs)
    model.__name__ = arch
...
def c_resunet(arch='c-ResUnet', n_features_start: int = 16, ae_bin: bool = False, n_out: int = 1, c0=True, pretrained: bool = False,
              progress: bool = True,
              **kwargs) -> ResUnet:
    ...
    """
    return _resunet(arch=arch, n_features_start=n_features_start, ae_bin=ae_bin, n_out=n_out, c0=c0, pretrained=pretrained,
