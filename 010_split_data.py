...
def main():
    ...
    # AllImages = root + 'DATASET_fluo/all_images/images/'
    # AllMasks = root + 'DATASET_fluo/all_masks/masks/'
    #
    # # create folder for train/validation data
    # TrainValImages = root + 'DATASET_fluo/train_val/full_size/all_images/images/'
    # TrainValMasks = root + 'DATASET_fluo/train_val/full_size/all_masks/masks/'
    #
    ...
    # TestImages = root + 'DATASET_fluo/test/all_images/images/'
    # TestMasks = root + 'DATASET_fluo/test/all_masks/masks/'
    #
    ...
    split_map_df.to_csv(root + 'DATASET_fluo/test_split_map.csv', index=False)
