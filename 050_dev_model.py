...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name',type=str, default = 'c_resunet',  help='model name. Options are [c_resunet, resunet, unet, small_unet]')
    ...
    if args.images == 'AugCropImagesBasic':
        ...
        if not cluster:
            images_path = AugCropImages + 'images'
            masks_path = AugCropMasks + 'masks'
        else:
    ...
    if 'c_resunet' in args.model_name.lower():
        print('c-ResUnet')
